          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-card">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <p className="font-medium">Sarah Mwangi - President</p>
                    <p className="text-sm text-muted-foreground">sarah.president@ekusa.com</p>
                  </div>
                  <div>
                    <p className="font-medium">Grace Njeri - Secretary General</p>
                    <p className="text-sm text-muted-foreground">grace.secretary@ekusa.com</p>
                  </div>
                  <div>
                    <p className="font-medium">Michael Ochieng - Treasurer</p>
                    <p className="text-sm text-muted-foreground">michael.treasurer@ekusa.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
